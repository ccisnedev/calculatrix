...
- 2026-09-26: D38 completed after Codex rounds 11 to 13 of PR #7: the range
  ...
  backward error bound is numerically zero, and the range of the result allows
  8 units of roundoff at the bounds.
